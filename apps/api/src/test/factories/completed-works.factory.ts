import type { CompletedWorksPersistence } from '../../modules/completed-works/completed-works.model.js';

type CompletedWorkFixtureOverrides = Partial<
  Omit<CompletedWorksPersistence, 'translations'>
> & {
  translations?: Partial<CompletedWorksPersistence['translations']>;
};

export function createCompletedWorkFixture(
  overrides: CompletedWorkFixtureOverrides = {},
): CompletedWorksPersistence {
  const defaultCompletedWork: CompletedWorksPersistence = {
    ...
    translations: {
      uk: {
        customerRequest:
          "Під автомобілем з'явилися плями оливи, а рівень моторної оливи поступо…",
        diagnosis:
  ...
  return {
    ...defaultCompletedWork,
    ...overrides,
    translations: {
      ...defaultCompletedWork.translations,
